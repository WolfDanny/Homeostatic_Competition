...
def main_diagonal_matrices(level, max_level, dimension, probability, mu, stimulus, model):
    """
...
def birth_diagonal_matrices(level, dimension, probability, stimulus):
    """
    ...
    for state in states:
        for i in range(len(state)):
            ...
            data.append(birth_rate(state, probability, i, dimension, stimulus))
            cols.append(level_position(level + 1, dimension, new_state))
            rows.append(level_position(level, dimension, state))
...
model_value = ModelHolder  # 0 = First auxiliary process (X^1), 1 = Second auxiliary process (X^2)
...
for level_value in range(dimension_value, max_level_value + 1):
    matrix = main_diagonal_matrices(level_value, max_level_value, dimension_value, probability_values, mu_value, stimulus_value, model_value)
...
for level_value in range(dimension_value, max_level_value):
    matrix = birth_diagonal_matrices(level_value, dimension_value, probability_values, stimulus_value)
...
parameters = (["dimension_value", "max_level_value", "mu_value", "gamma_value", "stimulus_value", "strata_number", "model_value"], dimension_value, max_level_value, mu_value, gamma_value, stimulus_value, strata_number, model_value)
