...
# probability_values = np.genfromtxt("../../Samples/Matrix-established-{}.csv".format(2), delimiter=",")
probability_values = np.genfromtxt("../../Matrix-{}.csv".format(2), delimiter=",")
...
file = open('Data-{0}-{1}.bin'.format(model_value, 2), 'wb')
