...
# probability_values = np.genfromtxt("../../Samples/Matrix-established-{}.csv".format(0), delimiter=",")
probability_values = np.genfromtxt("../../Matrix-{}.csv".format(0), delimiter=",")
...
file = open('Data-{0}-{1}.bin'.format(model_value, 0), 'wb')
