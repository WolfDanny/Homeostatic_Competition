    ...
    for current_matrix in range(matrices):
        ...
        for current_level in range(len(distribution[0])):
            ...
            for current_state in current_states:
                absorption_c1[
                    current_state[0] - 1, current_state[1] - 1
                ] += absorption_c1_list[current_level][
        ...
        for current_level in range(len(distribution[1])):
            ...
            for current_state in current_states:
                absorption_c2[
                    current_state[0] - 1, current_state[1] - 1
                ] += absorption_c2_list[current_level][
                    level_position(current_level + 2, 2, current_state)
                ]
        ...
        for current_level in range(len(distribution[2])):
            ...
            for current_state in current_states:
                absorption_c3[
                    current_state[0] - 1, current_state[1] - 1
                ] += absorption_c3_list[current_level][
                    level_position(current_level + 2, 2, current_state)
                ]
        ...
        for i in range(len(absorption_distribution)):
            absorption_distribution[i] = (
                absorption_distribution[i] / absorption_distribution[i].sum()
            )

        max_value = max(
            absorption_distribution[0].max(),
            absorption_distribution[1].max(),
            absorption_distribution[2].max(),
        )
        if folder == "Hard":
        ...
        for clone in range(3):
            ...
            for row in range(absorption_distribution[clone].shape[0]):
                for col in range(absorption_distribution[clone].shape[1]):
                    mean_value[0] += (row + 1) * absorption_distribution[clone][
                        row, col
                    ]
                    mean_value[1] += (col + 1) * absorption_distribution[clone][
                        row, col
                    ]
...
for current_matrix in range(matrices):
    subfigs[current_matrix].suptitle(
