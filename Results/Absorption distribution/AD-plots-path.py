...
fig.tight_layout(rect=(0.025, displacement, 1, 0.967))
...
graphs[0].set_title("$\\mathcal{U}^{1}_{\\mathbf{n}_{0}}$", fontsize=title_size, y=1.01)
...
graphs[1].set_title("$\\mathcal{U}^{2}_{\\mathbf{n}_{0}}$", fontsize=title_size, y=1.01)
...
graphs[2].set_title("$\\mathcal{U}^{3}_{\\mathbf{n}_{0}}$", fontsize=title_size, y=1.01)
